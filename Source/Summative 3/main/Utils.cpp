...
void Utils::setCubeData(std::vector<VertexFormat>& vertices, std::vector<GLuint>& indices) {
	...
	Indices.push_back(13); Indices.push_back(12); Indices.push_back(15);
	...
	Indices.push_back(21); Indices.push_back(20); Indices.push_back(23);  
...
//	std::vector<GLuint> Indices;
//
//	Vertices.push_back(VertexFormat(Position( 0.0f,  0.5f, 0.0f), TexCoord(0.0f, 0.0f), Normals(0.0f, 0.0f, 1.0f)));
//	Vertices.push_back(VertexFormat(Position( 0.5f, -0.5f, 0.0f), TexCoord(1.0f, 1.0f), Normals(0.0f, 0.0f, 1.0f)));
//	Vertices.push_back(VertexFormat(Position(-0.5f, -0.5f, 0.0f), TexCoord(0.0f, 1.0f), Normals(0.0f, 0.0f, 1.0f)));
//	
//	Indices.push_back(0);	Indices.push_back(1);	Indices.push_back(2);
//
//	vertices.clear();	indices.clear();
...
//	};
//
//	for (int i = 0; i < 46; i = i + 8)
//	{
//		VertexFormat vs;
//		vs.pos.x = quadVertices[i];
//		vs.pos.y = quadVertices[i + 1];
//		vs.pos.z = quadVertices[i + 2];
//		vs.texCoord.u = quadVertices[i + 6];
//		vs.texCoord.v = quadVertices[i + 7];
//		vs.normal.x = quadVertices[i + 3];
//		vs.normal.y = quadVertices[i + 4];
//		vs.normal.z = quadVertices[i + 5];
//		//Vertices.push_back(vs);
//	}
//
//	//Indices.push_back(0);	Indices.push_back(1);	Indices.push_back(2);
...
//	Vertices.push_back(VertexFormat(Position(-0.5f,  0.5f, 0.0f), TexCoord(0.0f, 1.0f), Normals(0.0f, 0.0f, 1.0f)));
//	Vertices.push_back(VertexFormat(Position( 0.5f,  0.5f, 0.0f), TexCoord(1.0f, 1.0f), Normals(0.0f, 0.0f, 1.0f)));
//	Vertices.push_back(VertexFormat(Position( 0.5f, -0.5f, 0.0f), TexCoord(1.0f, 0.0f), Normals(0.0f, 0.0f, 1.0f)));
//	Vertices.push_back(VertexFormat(Position(-0.5f, -0.5f, 0.0f), TexCoord(0.0f, 0.0f), Normals(0.0f, 0.0f, 1.0f)));
//
//	Indices.push_back(0);	Indices.push_back(1);	Indices.push_back(2);
//	Indices.push_back(0);	Indices.push_back(2);	Indices.push_back(3);
//
...
//	};
//
//	Vertices.push_back(VertexFormat(Position(-0.5f, -0.5f, -0.5f), TexCoord(0.0f, 1.0f), Normals(0.0f, 0.0f, -1.0f)));
//	Vertices.push_back(VertexFormat(Position(-0.5f,  0.5f, -0.5f), TexCoord(0.0f, 0.0f), Normals(0.0f, 0.0f, -1.0f)));
//	Vertices.push_back(VertexFormat(Position( 0.5f,  0.5f, -0.5f), TexCoord(1.0f, 0.0f), Normals(0.0f, 0.0f, -1.0f)));
//	Vertices.push_back(VertexFormat(Position( 0.5f, -0.5f, -0.5f), TexCoord(1.0f, 1.0f), Normals(0.0f, 0.0f, -1.0f)));
//
//	Vertices.push_back(VertexFormat(Position( 0.5f, -0.5f, 0.5f), TexCoord(0.0f, 1.0f), Normals(0.0f, 0.0f, 1.0f)));
//	Vertices.push_back(VertexFormat(Position( 0.5f,  0.5f, 0.5f), TexCoord(0.0f, 0.0f), Normals(0.0f, 0.0f, 1.0f)));
//	Vertices.push_back(VertexFormat(Position(-0.5f,  0.5f, 0.5f), TexCoord(1.0f, 0.0f), Normals(0.0f, 0.0f, 1.0f)));
//	Vertices.push_back(VertexFormat(Position(-0.5f, -0.5f, 0.5f), TexCoord(1.0f, 1.0f), Normals(0.0f, 0.0f, 1.0f)));
//
//	Vertices.push_back(VertexFormat(Position(-0.5f, 0.5f, -0.5f), TexCoord(0.0f, 1.0f), Normals(0.0f, 1.0f, 0.0f)));
//	Vertices.push_back(VertexFormat(Position(-0.5f, 0.5f,  0.5f), TexCoord(0.0f, 0.0f), Normals(0.0f, 1.0f, 0.0f)));
//	Vertices.push_back(VertexFormat(Position( 0.5f, 0.5f,  0.5f), TexCoord(1.0f, 0.0f), Normals(0.0f, 1.0f, 0.0f)));
//	Vertices.push_back(VertexFormat(Position( 0.5f, 0.5f, -0.5f), TexCoord(1.0f, 1.0f), Normals(0.0f, 1.0f, 0.0f)));
//
//	Vertices.push_back(VertexFormat(Position(-0.5f, -0.5f, -0.5f), TexCoord(1.0f, 1.0f), Normals(0.0f, -1.0f, 0.0f)));
//	Vertices.push_back(VertexFormat(Position( 0.5f, -0.5f, -0.5f), TexCoord(0.0f, 1.0f), Normals(0.0f, -1.0f, 0.0f)));
//	Vertices.push_back(VertexFormat(Position( 0.5f, -0.5f,  0.5f), TexCoord(0.0f, 0.0f), Normals(0.0f, -1.0f, 0.0f)));
//	Vertices.push_back(VertexFormat(Position(-0.5f, -0.5f,  0.5f), TexCoord(1.0f, 0.0f), Normals(0.0f, -1.0f, 0.0f)));
//
//	Vertices.push_back(VertexFormat(Position(-0.5f, -0.5f,  0.5f), TexCoord(0.0f, 1.0f), Normals(-1.0f, 0.0f, 0.0f)));
//	Vertices.push_back(VertexFormat(Position(-0.5f,  0.5f,  0.5f), TexCoord(0.0f, 0.0f), Normals(-1.0f, 0.0f, 0.0f)));
//	Vertices.push_back(VertexFormat(Position(-0.5f,  0.5f, -0.5f), TexCoord(1.0f, 0.0f), Normals(-1.0f, 0.0f, 0.0f)));
//	Vertices.push_back(VertexFormat(Position(-0.5f, -0.5f, -0.5f), TexCoord(1.0f, 1.0f), Normals(-1.0f, 0.0f, 0.0f)));
//
//	Vertices.push_back(VertexFormat(Position(0.5f, -0.5f, -0.5f), TexCoord(0.0f, 1.0f), Normals(1.0f, 0.0f, 0.0f)));
//	Vertices.push_back(VertexFormat(Position(0.5f,  0.5f, -0.5f), TexCoord(0.0f, 0.0f), Normals(1.0f, 0.0f, 0.0f)));
//	Vertices.push_back(VertexFormat(Position(0.5f,  0.5f,  0.5f), TexCoord(1.0f, 0.0f), Normals(1.0f, 0.0f, 0.0f)));
